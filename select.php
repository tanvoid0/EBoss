<?php
 ...
 {
      $output = '';
      $connect = mysqli_connect("localhost", "root", "", "eboss");
             ...
             <div class="row">
               <div class="col-12">
                 <div class="form-group row justify-content-md-center">
                   ...
                   <div class="col-8">
                     <input class="form-control" type="text" id="employeeName" name="employeeName" placeholder="Enter emoloyee name..." value="'$row['name']'">
                   </div>
                 </div>
                 <ul class="actions">
                     <li><h3>Image</h3></li>
                 ...
                 <div class="form-group row justify-content-md-center">
                   ...
                   <div class="col-8">
                     <input class="form-control" type="text" id="phoneNo" name="phoneNo" placeholder="Enter phone no..." value="'$row['phone']'">
                   </div>
                 </div>
                 <div class="form-group row justify-content-md-center">
